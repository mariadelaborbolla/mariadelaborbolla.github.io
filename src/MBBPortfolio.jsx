...
// PROVOCATIVE VERSION - Bold, asymmetric, rule-breaking
...
const MBBPortfolio = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ["hero", "work", "about", "credentials", "process", "contact"];
  ...
  const education = [
    {
      ...
      subtitle: "Industrial Design Engineering · Netherlands",
    },
    {
      period: "Sep 2022 – Feb 2023",
      title: "Tecnológico de Monterrey",
      subtitle: "Minor Abroad · Engineering & Sustainability",
    },
    {
      period: "Sep 2022 – Feb 2023",
      title: "AIRE Aviacion Integral Regional",
      subtitle: "Private Pilot License · Mexico",
    },
  ];

  const software = [
    { name: "SolidWorks", level: 95, certified: true },
    { name: "Keyshot", level: 85, certified: false },
    { name: "Rhinoceros", level: 80, certified: false },
    { name: "Photoshop", level: 80, certified: false },
    { name: "Procreate", level: 65, certified: false },
  ];

  const languages = [
    { code: "ES", name: "Spanish", level: "Native" },
    { code: "EN", name: "English", level: "C1" },
    { code: "NL", name: "Dutch", level: "Basic" },
    { code: "DE", name: "German", level: "Basic" },
    { code: "PL", name: "Polish", level: "Basic" },
  ];
    ...
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .skill-bar-fill { transition: width 1s cubic-bezier(0.16, 1, 0.3, 1); }
        ...
        @media (max-width: 768px) {
          ...
          .languages-grid { grid-template-columns: repeat(3, 1fr) !important; }
        }

        @media (max-width: 480px) {
          .process-grid { grid-template-columns: 1fr !important; }
          .hero-mark { font-size: 25vw !important; }
          .languages-grid { grid-template-columns: repeat(2, 1fr) !important; }
        }
      `}</style>
      ...
      >
        ...
        >
          ...
          <div className="nav-links" style={{ display: "flex", gap: "32px" }}>
            {["work", "about", "credentials", "process", "contact"].map((section) => (
              <a
                key={section}
                href={`#${section}`}
                className="nav-link"
          ...
          >
            <div style={{ paddingTop: "60px" }}>
              ...
              <div style={{ marginBottom: "48px" }}>
                ...
                >
                  Now in my 6th semester at Fontys University of Applied
        ...
        {/* Credentials Section - Education, Skills, Languages */}
        <section
          id="credentials"
          className="section"
          style={{
            ...
            >
              ...
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
                  ...
                  {/* SolidWorks Certification - Special callout */}
                  <div
                    style={{
                      padding: "24px",
                      backgroundColor: "#2D6A4F",
